...
public final class EndpointSearchDialog extends DialogWrapper {
    ...
    private final List<EndpointRow> endpoints;
    ...
    private JBList<EndpointRow> endpointList;
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        applyFilterResult(endpoints, null);
    ...
    private void installCopyPathAction() {
        KeyStroke copyPathKey = KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.META_DOWN_MASK);
        bindCopyPathKey(searchField, copyPathKey);
        bindCopyPathKey(endpointList, copyPathKey);
    }
    ...
    private void copySelectedEndpointPath() {
        ...
        CopyPasteManager.getInstance().setContents(new StringSelection(row.endpoint().getPath()));
    }
    ...
    private void filterAsync() {
        ...
        EndpointRow selectedRow = endpointList == null ? null : endpointList.getSelectedValue();
